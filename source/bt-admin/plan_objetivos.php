...
<div class="form">
    <form action="plan_objetivos.php" method="post" name="formbusqueda" class="general_form" id="formbusqueda">
        <div class="inner-page-title" style="padding-bottom:2px;">
          <h1><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Objetivos</h1>
        </div>
     ...
     <div class="col-md-6">
      ...
      <div class="col-md-6">
       <div class="pull-right">
        	<a class="btn btn-success" href="plan_objetivos_am.php"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Crear nuevo Objetivo</a>
		</div>
       </div>
</div>
<div class="clear aire_vertical">&nbsp;</div>
