...
if(!function_exists(' FuncionesPHPLocal::HtmlspecialcharsBigtree_decode')) {
	function  FuncionesPHPLocal::HtmlspecialcharsBigtree_decode ($str) {
...
function PreparePreText($text,$ff='//FF//') {
	// mPDF 5.0.053
	$text =  FuncionesPHPLocal::HtmlspecialcharsBigtree($text);
