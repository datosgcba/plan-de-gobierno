...
$oObjeto = new cPlanProyectosComunas($conexion,"");
...
{
	$linkdel = '<a class="eliminar" href="javascript:void(0)" onclick="EliminarComuna('.$fila['planproyectocod'].','.$fila['comunacod'].')" title="Eliminar" >&nbsp;</a>';
