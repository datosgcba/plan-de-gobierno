...
{
	case 1:
		if ($oMacrosEstructuras->Insertar($_POST,$plantmacrocod))
		{
		...
		break;
	case 2:
		if ($oMacrosEstructuras->Modificar($_POST))
		{
			$ret['IsSuccess'] = true;
		...
		break;
	case 3:
		if ($oMacrosEstructuras->Eliminar($_POST))
		{
			$ret['IsSuccess'] = true;
	...
	case 4:
		if($oMacrosEstructuras->ModificarOrden($_POST))
		{
			$ret['IsSuccess'] = true;	
