...
if ($ok)
{
	...
	switch($_POST['tipo'])
	{
		...
		case 2:
			...
			{
				$msg = "Se ha desactivado el top correctamente.";
				$ejecutobien = 1;
			}
		...
		case 3:
			...
			{
				$msg = "Se han activado el top correctamente.";
				$ejecutobien = 1;
			}
		...
		case 4:
			...
			{
				$msg = "Se han desactivado el top correctamente.";
				$ejecutobien = 1;
			}
		break;
		case 5:
			...
			{
				$msg = "Se ha eliminado el top correctamente.";
				$ejecutobien = 1;
			}
		break;
		case 6:
			...
			{
				$msg = "Se han eliminado el top correctamente.";
				$ejecutobien = 1;
			}
		break;
	}
