...
{
	FuncionesPHPLocal::MostrarMensaje($conexion,MSG_ERRGRAVE,"Error, codigo de pagina inexistente. ",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>FMT_TEXTO));
	return false;
}
...
{
	case 1:
		if($oPaginasPublicacion->DespublicarPagina($datos))
		{
			$msg['IsSucceed'] = true;
			FuncionesPHPLocal::MostrarMensaje($conexion,MSG_OK,"Se ha despublicado correctamente la página.",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>FMT_TEXTO));
		}	
		break;
