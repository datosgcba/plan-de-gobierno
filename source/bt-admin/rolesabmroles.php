...
var campos_linea=new Array("lst|listarolesizq[]|listarolesder[]");
...
while($filagrupo=$conexion->ObtenerSiguienteRegistro($resultado))
{
	...
	if(!$conexion->ejecutarStoredProcedure("sel_roles_xrolesactualizados",array('prolcodactualiza'=>$filagrupo['rolcod'],'porderby'=>"rolcod"),$resulrol,$numfilas,$errno)) die();

	$codigosel=array();
	while($filarol=$conexion->ObtenerSiguienteRegistro($resulrol))
		$codigosel[]=$filarol["rolcod"];
...
<div class="inner-page-title" style="padding-bottom:2px;">
    <h2>Roles ABM Roles</h2>
</div>
<div class="form">
    <form action="rolesabmroles_upd.php" class="general_form" method="post" name="formulario">
        <div class="ancho_1">&nbsp;</div>
        <div class="ancho_9">
            <div class="ancho_2" style="text-align:right; margin:5px 15px 0 0;">
                    <label>Rol </label>
                </div>
                <div class="ancho_3">
                    <?php 	
                ...
                <div class="ancho_10">
                    <?php 
                        FuncionesPHPLocal::ArmarListas($conexion,"sel_roles_orden",array('porderby'=>"rolcod"),"rolcod","roldesc","formulario","listaroles","Roles Disponibles","Roles Seleccionados","width: 100%",15,false)
                    ?>
                </div>
               <div class="clearboth aire">&nbsp;</div>
               <div class="ancho_2">&nbsp;</div>
               <div class="ancho_8">
                    <div class="ancho_boton aire"><input type="submit" class="boton verde" name="botonalta"  value="Actualizar" onclick="SeleccionarTodosLista(formulario['listarolesder[]']);return Validarjs(formulario)" /></div>
