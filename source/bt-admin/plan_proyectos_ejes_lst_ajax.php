...
$oObjeto = new cPlanProyectosEjes($conexion,"");
...
{
	$linkdel = '<a class="eliminar" href="javascript:void(0)" onclick="EliminarEjes('.$fila['planproyectocod'].','.$fila['planejecod'].')" title="Eliminar" >&nbsp;</a>';
