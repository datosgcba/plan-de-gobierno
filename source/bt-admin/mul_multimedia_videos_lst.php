...
$urlSiguiente = "mul_multimedia_videos_lst.php";
...
<script type="text/javascript" src="modulos/mul_multimedia_modulo/js/mul_multimedia_modulo_videos.js"></script>
            ...
            <?php   while ($fila = $conexion->ObtenerSiguienteRegistro($resultado))
                    {
                       ...
                       <li class="caja_imagen"  id="imagen_<?php  echo $fila['multimediacod']?>">
                            ...
                            <div class="ancho">
                                <img src="<?php  echo  $oMultimedia->DevolverDireccionImg($fila)?>" height="182px" alt="Imagen de <?php  echo  $fila['multimediatitulo']?> " />
                            </div>
                            ...
                            <a class="zoom_image" onclick="VisualizarMultimedia(<?php  echo $fila['multimediacod']?>,<?php  echo  $fila['multimediaconjuntocod'] ?>); return false;" href="javascript:void(0)" >
                               &nbsp
                            </a>
