...
if (isset ($_GET['spcod']))
{
	...
	if (!$oStored->Buscar ($ArregloDatos,$numfilas,$resultado))
		$result=false;
...
function ValidarjsBotonBuscar(formulario) 
{
	...
	{
		alert("Debe ingresar el nombre del Stored Procedure");
	...
	}else
	{
		...
		while (i<datos_grilla.length)
		{
			...
			{	
				...
				{
					alert("Existe otro Stored Procedure con el mismo nombre");
					formulario.spnombre.focus();
					return false;
				}
			}	
...
<div class="form">
        <form action="stored_upd.php" class="general_form" method="post" name="formulario" >
			<div class="ancho_10 aire">
                ...
                <div class="ancho_9">
                    ...
                    <div class="ancho_4">
						<?php 	
							FuncionesPHPLocal::ArmarCombo_SinSalto_BD($conexion,"sel_stored_orden",array('porderby'=>"spcod"),"formulario","spcodviejo","spcod","sptodo",$codigo,"Nuevo Stored",$regnousar,$selecnousar,1,"SeleccionCombo(formulario,campos_linea,datos_grilla,this.selectedIndex)","","",false,"","","chzn-select-modulo");
                        ?>
                    </div>
                ...
                <div class="ancho_9">
                    <div class="ancho_1">
                        <a href="javascript:void(0)" onclick="popup('storedpopup.php?Destino=spsqlstring','ventana_descripciones',430,360,screen.availWidth-450,screen.availHeight-420,'yes');"> 
                            <b>Generar C&oacute;digo SQL</b>
                        </a>
                        <br /><br />
                        <a href="javascript:void(0)" onclick="popup('storedphp.php?Destino=spsqlstring','ventana_descripciones',430,360,screen.availWidth-450,screen.availHeight-420,'yes');"> 
