...
function gridReload(){
	...
	jQuery("#listarDatos").jqGrid('setGridParam', {url:"plan_proyectos_lst_ajax.php?rand="+Math.random(), postData: datos,page:1}).trigger("reloadGrid");
}
function Resetear(){
	$("#planproyectocodigo").val("");
	$("#planproyectonombre").val("");
	$("#planobjetivocod").val("");
	$("#planjurisdiccioncod").val("");
	$("#planproyectoestadocod").val("");
	timeoutHnd = setTimeout(gridReload,500);
}
...
function listar(){
	...
	{
		url:'plan_proyectos_lst_ajax.php?rand='+Math.random(),
		postData: datos,
		datatype: "json", 
		colNames:['C\u00f3digo','Nombre','Objetivo','Jurisdicci\u00f3n','Estado','Estado','Editar','Eliminar'],
		colModel:[
			{name:'planproyectocod',index:'planproyectocod', width:25, align:'center'},
			{name:'planproyectonombre',index:'planproyectonombre', align:'left'},
			{name:'planobjetivocod',index:'planobjetivocod', align:'left'},
			{name:'planjurisdiccioncod',index:'planjurisdiccioncod', align:'left'},
			{name:'planproyectoestadocod',index:'planproyectoestadocod', align:'left'},
