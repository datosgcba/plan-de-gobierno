...
function doSearch(ev){ 
	...
	jQuery("#listarDatos").jqGrid('setGridParam', {url:"gcba_barrios_lst_ajax.php?rand="+Math.random(), postData: datos,page:1}).trigger("reloadGrid");
}
function Resetear(){
	$("#barriocod").val("");
	$("#barrionombre").val("");
	...
	{
		url:'gcba_barrios_lst_ajax.php?rand='+Math.random(),
		postData: datos,
		datatype: "json", 
		colNames:['C\u00f3digo','Nombre','Estado','Editar','Eliminar'],
		colModel:[
			{name:'barriocod',index:'barriocod', width:25, align:'center'},
