...
function doSearch(ev){ 
	...
	jQuery("#listarDatos").jqGrid('setGridParam', {url:"gcba_comunas_lst_ajax.php?rand="+Math.random(), postData: datos,page:1}).trigger("reloadGrid");
}
function Resetear(){
	$("#comunacod").val("");
	$("#comunanumero").val("");
	...
	{
		url:'gcba_comunas_lst_ajax.php?rand='+Math.random(),
		postData: datos,
		datatype: "json", 
		colNames:['C\u00f3digo','N\u00famero','Barrios','Estado','Editar','Eliminar'],
		colModel:[
			{name:'comunacod',index:'comunacod', width:25, align:'center'},
			{name:'comunanumero',index:'comunanumero', align:'left'},
