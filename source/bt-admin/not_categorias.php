...
<link rel="stylesheet" type="text/css" href="modulos/not_categorias/css/not_categorias.css" />
<script type="text/javascript" src="modulos/not_categorias/js/not_categorias.js"></script>
<div class="inner-page-title" style="padding-bottom:2px;">
    <div class="row">
        <div class="col-md-10">
            <h1><i class="fa fa-th-list"></i>&nbsp;Categor&iacute;as de Noticias</h1>
        </div>
	</div>
</div>

<div class="form">
    <form action="not_categorias.php" method="post" name="formbusqueda" id="formbusqueda">
...
<div class="menubarra">
    <a class="btn btn-success" href="not_categorias_am.php?catsuperior=<?php  echo $catsuperior ?>"><i class="fa fa-plus"></i>&nbsp;Crear nueva Categoria</a>
</div>
<?php  
