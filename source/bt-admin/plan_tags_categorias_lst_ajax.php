...
{
	$linkedit = '<a class="btn btn-xs btn-primary" href="plan_tags_categorias_am.php?plantagcatcod='.$fila["plantagcatcod"].'" title="Editar" id="editar_'.$fila['plantagcatcod'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Editar</a>';
	$tipoactivacion = 5;
	$class = "desactivo";
	...
	$linkdel = '<a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="Eliminar('.$fila['plantagcatcod'].')" title="Eliminar" ><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Eliminar</a>';
