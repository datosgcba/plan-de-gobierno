...
switch ($_POST['accion'])
{
	case 1:
		...
		{
			$msgactualizacion = utf8_encode("Se ha agregado la categoria de la página correctamente.");
			$ret['IsSuccess'] = true;	
	...
	case 2:
		...
		{
			$msgactualizacion = utf8_encode("Se ha modificado la categoria de la página correctamente.");
			$ret['IsSuccess'] = true;	
		}
		break;
	case 3:
		...
		{
			$ret['IsSuccess'] = true;
			$msgactualizacion = utf8_encode("Se ha eliminado la categoria de la página correctamente.");
	...
	case 6:
		...
		{
			$ret['IsSuccess'] = true;	
			$msgactualizacion = utf8_encode("Se ha modificado el orde de la categoria de la página correctamente."); 
		}
