...
<script type="text/javascript" src="js/multimediaSelectorPopupFotos.js"></script>
<div>
    <div id="mul_multimedia_fotos_<?php  echo $campoDevolucion?>">
       <ul>
            <li><a href="#mul_multimedia_subir_simple">Nueva Im&aacute;gen</a></li>
            <li><a href="#mul_multimedia_repositorio_simple">Seleccionar una Im&aacute;gen Existente</a></li>
        </ul>
                   ...
                   <div class="ancho_10">
                    ...
                    <div class="ancho_7" id="mul_multimedia_descripcion" style="display:none">
                       ...
                       <div class="ancho_6">
                    	...
                    	<input type="text" name="multimedia_titulo" style="width:100%" id="multimedia_titulo" maxlength="255" class="form-control input-md" />
	                    <div class="clear brisa_vertical">&nbsp;</div>
                    	<textarea name="multimedia_desc" style="width:100%" id="multimedia_desc" cols="20" rows="4"></textarea>
	                    <div class="clear brisa_vertical">&nbsp;</div>
                        <div class="menubarra">
                            <ul>
                                <li><div class="ancho_boton aire"><a class="btn btn-success" href="javascript:void(0)" onclick="SubirImagen()">Guardar y seleccionar Im&aacute;gen</a></div></li>
                            	<li><div class="ancho_boton aire"><a class="btn btn-default" href="javascript:void(0)"  onclick="DialogClose()">Cerrar Ventana</a></div></li>
                            </ul>
                        </div>        
                    </div>
                    <div class="clear fixalto">&nbsp;</div>
            	...
            	<div class="form">
                    <form action="javascript:void(0)" method="post" name="formbusquedamultimedia" id="formbusquedamultimedia">
                        <div class="ancho_10">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="criteriobusqueda" class="form-control input-md" value="" />
                          	</div> 
                            <div class="col-md-2"> 
                                <a class="btn btn-info" href="javascript:void(0)" onclick="gridReloadMultimedia()">Buscar</a>
                                </div>        
                            </div>
