...
{
	$linkedit = '<a class="btn btn-xs btn-primary" href="plan_proyectos_am.php?planproyectocod='.$fila["planproyectocod"].'" title="Editar" id="editar_'.$fila['planproyectocod'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Editar</a>';
	$tipoactivacion = 5;
	$class = "desactivo";
	...
	$linkdel = '<a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="Eliminar('.$fila['planproyectocod'].')" title="Eliminar" ><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Eliminar</a>';

	$datosmostrar = array(
		utf8_encode(FuncionesPHPLocal::HtmlspecialcharsBigtree($fila['planproyectocodigo'],ENT_QUOTES)),
