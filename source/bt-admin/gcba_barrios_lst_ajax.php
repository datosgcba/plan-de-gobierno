...
{
	$linkedit = '<a class="btn btn-xs btn-primary" href="gcba_barrios_am.php?barriocod='.$fila["barriocod"].'" title="Editar" id="editar_'.$fila['barriocod'].'"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Editar</a>';
	$tipoactivacion = 5;
	$class = "desactivo";
	...
	$linkdel = '<a class="btn btn-xs btn-danger" href="javascript:void(0)" onclick="Eliminar('.$fila['barriocod'].')" title="Eliminar" ><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Eliminar</a>';
