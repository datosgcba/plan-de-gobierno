...
$_SESSION['volveratras'] = "mul_multimedia_archivos.php";
...
var archivoreload = "mul_multimedia_archivos_lst.php";
...
<div class="form">
    <form action="mul_multimedia_archivos.php" method="post" name="busquedamultimedia" id="busquedamultimedia">
		<div class="ancho_10">
...
<div class="multimedia_alta menubarra">
    <ul>
        <li><a class="left boton verde" href="javascript:void(0)" onclick="return AbrirPopupNuevoArchivoModuloArchivos()">Nuevo Archivo</a></li>
    </ul>
</div>   
