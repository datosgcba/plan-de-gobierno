...
$_SESSION['volveratras'] = "mul_multimedia_imagenes.php";
...
var archivoreload = "mul_multimedia_imagenes_lst.php";
...
<div class="form">
    <form action="mul_multimedia_imagenes.php" method="post" name="busquedamultimedia" id="busquedamultimedia">
        ...
        <div class="BtcontactoFondo" style="float:left">
            <div class="ancho_10">
                <div class="ancho_4">
                    <input class="boton azul" style="float:left" type="button" name="Limpiar"   value="Buscar" onclick=" return Buscar();" />
                </div>
                <div class="ancho_6">
                    <input class="boton base" style="float:left"  type="button" name="Limpiar"  value="Limpiar Filtros" onclick=" return LimpiarFiltrosImagenes();" />
                 </div>
            </div>
        </div> 
        <div class="clear fixalto">&nbsp;</div>
...
<div class="multimedia_alta menubarra">
    <ul>
        <li><a class="boton verde" href="javascript:void(0)" onclick="return AbrirPopupNuevaFotoModuloImagenes()">Nueva Foto</a></li>
    </ul>
</div>   
