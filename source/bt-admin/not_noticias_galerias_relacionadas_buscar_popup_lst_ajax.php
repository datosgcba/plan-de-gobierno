...
if ($numfilas>0)
{
	...
	{
		//print_r($fila);
		$link = '<a class="aceptar" href="javascript:void(0)" onclick="InsertarNoticiaGaleriaRelacionada(\''.utf8_encode( FuncionesPHPLocal::HtmlspecialcharsBigtree($fila['galeriatitulo'],ENT_QUOTES)).'\','.$fila['galeriacod'].')" title="Seleccionar Noticia" >Seleccionar</a>';
