...
//----------------------------------------------------------------------------------------- 
//----------------------------------------------------------------------------------------- 
// Clase con la lógica para el manejo de grupo de modulos - modulos

include(DIR_CLASES_DB."cGruposmodModulos.db.php");

class cGruposmodModulos extends cGruposmodModulosdb	
{
	protected $conexion;
	protected $formato;
...
//		la función retorna true o false si se pudo ejecutar con éxito o no
	...
	function Insertar ($ArregloDatos)
	{
		...
		if ($numfilas==1)
		{
			FuncionesPHPLocal::MostrarMensaje($this->conexion,MSG_ERRGRAVE,"Error, El Grupomod - Módulo ya se encuentra insertado en la tabla de Grupomod_Módulos.",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>$this->formato));
			return false;
		}
