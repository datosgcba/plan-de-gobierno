			...
			<textarea class="form-control input-md" rows="6" cols="20" name="barriodesc" id="barriodesc"><?php   echo $barriodesc?></textarea>
                    ...
                    <div class="menubarra">
                        <ul>
                            ...
                            <li><div class="ancho_boton aire"><a class="btn btn-default" href="gcba_barrios.php"><i class="fa fa-backward"></i>&nbsp;Volver</a></div></li>
                        	                        </ul>
                    ...
                    <div class="menubarra pull-right">
                        <ul>
                            <li><div class="ancho_boton aire"><a class="btn btn-success" href="gcba_barrios_am.php">Crear nuevo </a></div></li>
                        </ul>
                        <div class="clearboth">&nbsp;</div>
                    </div>    
