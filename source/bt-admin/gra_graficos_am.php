...
{
	FuncionesPHPLocal::MostrarMensaje($conexion,MSG_ERRGRAVE,"Error, el grafico no corresponde a una edición de 2 ejes. ",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>FMT_TEXTO));
	die();
}
...
$graficomuestravaloreseje = $datosgrafico['graficomuestravaloreseje'];
$graficomuestravaloresseries = $datosgrafico['graficomuestravaloresseries'];

FuncionesPHPLocal::ArmarLinkMD5("gra_graficos_upd.php",array("graficocod"=>$graficocod),$get_upd,$md5_upd);
?>
<link type="text/css" rel="stylesheet" href="css/jquery.miniColors.css" />
<script type="text/javascript" src="modulos/gra_graficos/js/gra_graficos_am.js"></script>
	...
	<div class="ancho_10">
         <div class="ancho_4">
            <div class="datosgenerales">
            	...
            	<div class="ancho_10">
                    <div class="ancho_2">
                        <div>
                            <label>Invertir Gr&aacute;fico:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficoinvertir"  id="graficoinvertir">
                                <option value="0"  <?php  if ($graficoinvertir==0 || $graficoinvertir==""  ) echo 'selected="selected"'?>>No</option>
                                <option value="1"  <?php  if ($graficoinvertir==1 ) echo 'selected="selected"'?>>Si</option>
                            </select>
                        </div>
					</div>
                    ...
                    <div class="ancho_2">
                        <div>
                            <label>Acepta Zoom:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficozoom"  id="graficozoom">
                                <option value="0"  <?php  if ($graficozoom==0 || $graficozoom==""  ) echo 'selected="selected"'?>>No</option>
                                <option value="1"  <?php  if ($graficozoom==1 ) echo 'selected="selected"'?>>Si</option>
                            </select>
                        </div>
					</div>
                </div>    
				...
				<div class="ancho_10">
	                <div class="ancho_6">
                        ...
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <input type="text" name="graficotitulo" <?php  if ($esbaja) echo 'disabled="disabled"'?> id="graficotitulo" class="full" maxlength="255" size="60" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($graficotitulo,ENT_QUOTES);?>" />
                        </div>
					</div>
                    <div class="ancho_1">&nbsp;</div>
	                <div class="ancho_2">
				...
				<div class="ancho_10">
	                <div class="ancho_6">
                        ...
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <input type="text" name="graficodesc" <?php  if ($esbaja) echo 'disabled="disabled"'?> id="graficodesc" class="full" maxlength="255" size="60" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($graficodesc,ENT_QUOTES);?>" />
                        </div>
					</div>
                    <div class="ancho_1">&nbsp;</div>
	                <div class="ancho_2">
				...
				<div class="ancho_10">
	                <div class="ancho_6">
                        <div>
                            <label>Titulo Eje:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <input type="text" name="graficotitulocolumnas" <?php  if ($esbaja) echo 'disabled="disabled"'?> id="graficotitulocolumnas" class="full" maxlength="80" size="60" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($graficotitulocolumnas,ENT_QUOTES);?>" />
                        </div>
                    </div>
                    <div class="ancho_1">&nbsp;</div>
	                <div class="ancho_2">
                        ...
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficotitulocolumnasalign"  id="graficotitulocolumnasalign">
                                <option value="low"  <?php  if ($graficotitulocolumnasalign=="low" || $graficotitulocolumnasalign==""  ) echo 'selected="selected"'?>>Izquierda</option>
                                <option value="middle"  <?php  if ($graficotitulocolumnasalign=="middle") echo 'selected="selected"'?>>Centro</option>
                                <option value="high"  <?php  if ($graficotitulocolumnasalign=="high") echo 'selected="selected"'?>>Derecha</option>
                            </select>
                        </div>
                    </div>
                 </div>       
				...
				<div class="ancho_10">
	                <div class="ancho_6">
                        <div>
                            <label>Titulo Series:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <input type="text" name="graficotitulofilas" <?php  if ($esbaja) echo 'disabled="disabled"'?> id="graficotitulofilas" class="full" maxlength="80" size="60" value="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($graficotitulofilas,ENT_QUOTES);?>" />
                        </div>
                    </div>
                    <div class="ancho_1">&nbsp;</div>
	                <div class="ancho_3">
                        ...
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficotitulofilasalign"  id="graficotitulofilasalign">
                                <option value="low"  <?php  if ($graficotitulofilasalign=="low"   ) echo 'selected="selected"'?>>Abajo</option>
                                <option value="middle"  <?php  if ($graficotitulofilasalign=="middle" || $graficotitulofilasalign=="") echo 'selected="selected"'?>>Centro</option>
                                <option value="high"  <?php  if ($graficotitulofilasalign=="high") echo 'selected="selected"'?>>Arriba</option>
                            </select>
                        </div>
                    </div>
                 </div>       
            	...
            	<div class="ancho_10">
                    <div class="ancho_2">
                        <div>
                            <label>Muestra Valores Eje:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficomuestravaloreseje"  id="graficomuestravaloreseje">
                                <option value="1"  <?php  if ($graficomuestravaloreseje==1 ) echo 'selected="selected"'?>>Si</option>
                                <option value="0"  <?php  if ($graficomuestravaloreseje==0 || $graficomuestravaloreseje==""  ) echo 'selected="selected"'?>>No</option>
                            </select>
                        </div>
					</div>
                    <div class="ancho_1">&nbsp;</div>
                    <div class="ancho_2">
                        <div>
                            <label>Muestra Valores Series:</label>
                        </div>
                        <div class="clearboth brisa_vertical">&nbsp;</div>
                        <div>
                            <select name="graficomuestravaloresseries"  id="graficomuestravaloresseries">
                                <option value="1"  <?php  if ($graficomuestravaloresseries==1 ) echo 'selected="selected"'?>>Si</option>
                                <option value="0"  <?php  if ($graficomuestravaloresseries==0 || $graficomuestravaloresseries==""  ) echo 'selected="selected"'?>>No</option>
                            </select>
                        </div>
					</div>
				</div>
		...
		<div class="ancho_6">
            ...
            <div style="font-size:14px; font-weight:bold; margin-bottom:5px; text-align:right">
                <a class="boton verde" href="javascript:void(0)" onclick="AgregarEjeX()">Agregar Eje</a>
            </div>
            <div id="LstColumnas" style="width:100%;">
                <table id="ListarColumnas"></table>
            </div>
            <div class="clear aire_vertical">&nbsp;</div>
            <div style="font-size:14px; font-weight:bold; margin-bottom:5px; text-align:right">
                <a class="boton verde" href="javascript:void(0)" onclick="AgregarEjeY()">Agregar Series</a>
            </div>
