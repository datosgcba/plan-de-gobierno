...
{
	case 1:
		if($oNoticias->Publicar($datos))
		{
			$msg['IsSucceed'] = true;
			FuncionesPHPLocal::MostrarMensaje($conexion,MSG_OK,"Se ha publicado correctamente la noticia.",array("archivo" => __FILE__,"funcion" => __FUNCTION__, "linea" => __LINE__),array("formato"=>FMT_TEXTO));
		}	
		break;
