...
$erroren = "";
$vars['conexion']->_EjecutarQuery($sql,$erroren,$resultado,$errno);


$cantidad = $vars['conexion']->ObtenerCantidadDeRegistros($resultado);
$i=0;
?>
<script type="text/javascript">
jQuery(document).ready(function(){
	$("#doughnutChart").drawDoughnutChart([
	  <? while($fila = $vars['conexion']->ObtenerSiguienteRegistro($resultado)){?>
		  { 
