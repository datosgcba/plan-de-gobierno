...
$muestraurl = false;
$titulo = $datosbanner['bannerdesc'];	
$descripcion = $datosbanner['bannerdesclarga'];	
...
?>
<div class="bannertitulodescripcion tap_modules" id="module_<?php  echo $vars['zonamodulocod']?>" <?php  echo  $vars['mouseaction']?>>
	<?php  echo $vars['htmledit']?>
       <div class="cajabannerinformacion clearfix">
           <div class="bannerizq"> 
				<?php  if ($muestraurl){?>
                    <a href="/banner/<?php  echo $datosbanner['bannercod']."/".$md5?>" target="<?php  echo $target?>"  style="color:<?php  echo $ColorTitulo?>;" title="<?php  echo  FuncionesPHPLocal::HtmlspecialcharsBigtree($datosbanner['bannerdesc'],ENT_QUOTES);?>">
                <?php  }?>
              		  <?php  echo $html;?>
                <?php  if ($muestraurl){?>
                        </a>
