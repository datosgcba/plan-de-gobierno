...
if (isset($vars['zonamodulocod']))
{
	...
	if (isset($objDataModel->CantidadCarrousel))
...
<div style="text-align:left;">
    ...
    <div style="clear:both">&nbsp;</div>    
    <div style="float:left; width:20%">
    	<label>Cantidad Carrousel:</label>
    </div>
	<div style="float:left; width:20%;">
    	<select name="CantidadCarrousel" id="CantidadCarrousel">
		<?php  for($i=1;$i<20;$i++){?>
        	<option value="<?php  echo $i?>" <?php  if ($i==$CantidadCarrousel) echo 'selected="selected"'?>><?php  echo $i?></option>
        <?php  }?>
        </select>
    </div>
    <div style="clear:both">&nbsp;</div>
