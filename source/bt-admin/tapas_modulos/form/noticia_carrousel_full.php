...
$MuestraBotonera = 1;
$idiomacod="";
//si viene seteado el idioma lo pongo para buscar las noticias por el idioma 
if(isset($vars['idiomacod']) && $vars['idiomacod']!="")
	$idiomacod=$vars['idiomacod'];
...
if (isset($vars['zonamodulocod']))
{
	...
	if (isset($objDataModel->idiomacod))
		$idiomacod = $objDataModel->idiomacod;
}
$valoranchodefault = "100";
$oNoticias= new cNoticias($vars['conexion']);
$datos=array(); 
$datos['noticiaidiomacod'] = $idiomacod;
...
$oIdiomas = new cIdiomas($conexion);
$datosIdi = "";
if(!$oIdiomas->BuscarIdiomas($datosIdi,$resultadoIdiomas,$numfilasIdiomas))
	die();
        ...
        <div style="float:left; width:280px; text-align:left;">
                ...
                <div style="clear:both; height:3px;">&nbsp;</div>
              	<div style="float:left; width:100%;">
                    <label>Idioma:</label>
                    <select name="idiomacod" id="idiomacod" class="chzn-select-idioma" onchange="SearchNoticia(arguments[0]||event)">
                        <option value="">Seleccionar un idioma...</option>
                        <?php  while($datosIdioma = $conexion->ObtenerSiguienteRegistro($resultadoIdiomas)){
                            ?>
                            <option value="<?php  echo $datosIdioma['idiomacod']?>" <?php  if($datosIdioma['idiomacod']==$idiomacod) echo 'selected="selected"'?>><?php  echo $datosIdioma['idiomatitulo']?></option>
                        <?php  }?>
                    </select>
                </div>
...
<div style="float:left; width:375px; margin-left:30px">
    <div>
    	<h2 class="titulopopup">Datos Generales</h2>
     	<?php  /*<label>Tipo Carrousel:</label>
        <select name="TipoCarrousel" id="TipoCarrousel"  class="full" style="width:60%; text-align:left;">
            <option value="1" <?php  if ($TipoCarrousel=="1") echo 'selected="selected"'?>>Tama&ntilde;o completo</option>
            <option value="2" <?php  if ($TipoCarrousel=="2") echo 'selected="selected"'?>>Con navegaci&oacute;n</option>
        </select> */?>
    </div>
    ...
    <div style="margin:5px 0px 5px 0px">
        <label>Ancho de Caja de texto:</label>
        <input type="text" value="<?php  echo $valoranchodefault ?>" id="TamanioNoticia" name="TamanioNoticia" maxlength="4" size="5" />%(caja de texto)
...
<script type="text/javascript">
	...
	function BuscarNoticia()
	{
		...
		param = "noticiaidiomacod="+$("#idiomacod").val();
		param += "&limit=5";
		$.ajax({
		   type: "POST",
