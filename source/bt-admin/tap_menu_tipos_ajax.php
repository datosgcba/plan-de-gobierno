...
if ($numfilas>0)
{
	...
	while ($fila = $conexion->ObtenerSiguienteRegistro($resultado))
	{
		//print_r($fila);	
			...
			$linkedit ='<a class="btn btn-xs btn-primary" href="tap_menu_detalle.php?menutipocod='.$fila['menutipocod'].'&md5='.$md5menutipo.'" title="Editar Menu" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Editar</a>';
