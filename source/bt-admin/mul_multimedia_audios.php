...
$_SESSION['volveratras'] = "mul_multimedia_audios.php";
...
var archivoreload = "mul_multimedia_audios_lst.php";
...
<div class="form">
    <form action="mul_multimedia_audios.php" method="post" name="busquedamultimedia" id="busquedamultimedia">
		<div class="ancho_10">
...
<div class="multimedia_alta menubarra">
    <ul>
        <li><a class="left boton verde" href="javascript:void(0)" onclick="return AbrirPopupNuevoAudioModuloAudios()">Nuevo Audio</a></li>
    </ul>
</div>   
