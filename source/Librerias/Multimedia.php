...
class Multimedia {
     ...
     */
    static function GetImagenStatic($width, $height, $advLink = "", $resize = true, $crop=0, $credito = 'N', $watermark = 'N') {
    ...
    public function GetExternalImageResized($src, $picName, $width, $height, $crop = 0) {
 	...
 	function VerVideo(&$conexion,$multimediacod,$width=500,$height=300,$conPreview=false)
	{
		...
		switch ($datosMultimedia['multimediatipocod'])
		{
			...
			default:	
				...
				{
					$img = DOMINIO_SERVIDOR_MULTIMEDIA.Multimedia::GetImagenStatic($width, $height, $datosMultimedia['multimediacatcarpeta']."N/".$datosMultimedia['previewubic'],true,1);
				}
